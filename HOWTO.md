...
Per visualizzare o inserire una richiesta di supporto o segnalazione collegarsi alla pagina [https://github.com/italia/spid/issues](https://github.com/italia/spid/issues).
...
Per cercare una richiesta di supporto o segnalazione possono essere utilizzati i filtri e il form di ricerca; di default vengono mostrate solo quelle aperte, per vedere tutte le segnalazioni basta digitare, nel campo di ricerca, "is:issue is:closed is:open"
...
Issue non commentate
[q=is:issue is:open comments:0](https://github.com/italia/spid/issues?utf8=✓&q=is:issue is:open comments:0)

Issue che sono state commentate da un utente (umbros)
...
Issue che contengono una stringa (spid) nel titolo
